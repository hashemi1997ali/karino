        ...
        <section className="desk-panel overflow-hidden">
          ...
          <div className="grid gap-px bg-[var(--border)]/70 sm:grid-cols-2">
            {attention.map(({ label, value, href, icon: Icon }, index) => (
              ...
              >
                <span
                  className="desk-icon-well shrink-0"
                  data-tone={value > 0 ? "danger" : undefined}
                >
                ...
                <ArrowUpRight className="size-4 text-[var(--muted)] transition group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-[var(--primary)]" />
              </Link>
            ))}
          </div>
        </section>
