...
export function ChatThreadHeader({
  ...
  return (
    <header className="desk-toolbar flex min-h-18 shrink-0 items-center gap-2 border-b bg-[color-mix(in_srgb,var(--surface)_88%,var(--surface-muted))] px-2 py-2 backdrop-blur-xl sm:gap-3 sm:px-4">
      <ChatIconButton
        bare
