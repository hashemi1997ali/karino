  ...
  return (
    <details className={cn("group relative", className)}>
      ...
      >
        ...
        <div
          className="grid grid-cols-2 gap-1.5 rounded-[1rem] border bg-[var(--surface-muted)] p-1.5"
          role="group"
        ...
        >
          {(
            ...
            <button
              ...
              className={cn(
                "focus-ring flex h-10 items-center justify-center rounded-[0.7rem] px-3 text-sm font-bold transition",
                locale === value
