...
const base =
  "inline-flex h-7 w-fit shrink-0 items-center justify-center whitespace-nowrap rounded-full border px-2.5 text-[11px] font-bold leading-none tracking-[0.01em] shadow-[inset_0_1px_0_rgb(255_255_255_/_0.35)]";
