    ...
    <DialogPrimitive.Root open={open} onOpenChange={onOpenChange}>
      <DialogPrimitive.Portal>
        ...
        >
          ...
          {children}
          <DialogPrimitive.Close className="focus-ring absolute right-4 top-4 grid size-10 place-items-center rounded-xl border border-transparent text-[var(--muted)] hover:border-[var(--border)] hover:bg-[var(--surface-muted)] hover:text-[var(--foreground)]">
            <X className="size-4" />
